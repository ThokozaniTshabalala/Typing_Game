...
public class WordMover extends Thread {
	...
	// this class is for one word at a time
	// my assumption is that every word in the GUI is an object of this class
	private FallingWord myWord; //FallingWord has a speed
	private AtomicBoolean done;
	private AtomicBoolean pause; 
	private Score score;
	CountDownLatch startLatch; //so all can start at once

	// where do words come from, which class?
	// constructor for word mover
	// this constructor initializes the "word" argument. The word argument is a (fallingWord object)
	...
	// constructor for word mover
	//initializes word, Score, startLatch, done and pause

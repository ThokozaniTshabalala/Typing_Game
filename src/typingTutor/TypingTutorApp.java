...
//shared class variables
	...
	static HungryWordMover[] wrdShftH;
	   ...
	   textEntry.addActionListener(new ActionListener() {
	      public void actionPerformed(ActionEvent evt) { 
	    	  ...
	    	  if (!pause.get()) {
				  ...
				  // check what happens when this text is passed to CatchWord.
				  // what happens is that the instance variable "target" is set to this text in CatchWord class.

				  //System.out.println("CatchWord run method called");
	    		  catchThread.start(); //set 'm running
				  // run method in CatchWord class is called to run.
				  // run method in CatchWord checks if the text input is in words[] array
